...
class StationSlotLayoutLoaderTest extends BaseMcTest {
  ...
  void minimal_noTool() {
    ...
    assertThat(layout.getName().toString()).isEqualTo("modernfoundry:minimal");
  ...
  void minimal_withTool() {
    ...
    assertThat(layout.getName().toString()).isEqualTo("modernfoundry:minimal_with_tool");
    assertThat(layout.getTranslationKey()).isEmpty();
    assertThat(layout.getIcon()).isSameAs(LayoutIcon.EMPTY);
    assertThat(layout.getSortIndex()).isEqualTo(255);
    // slots
  ...
  void full() {
    ...
    assertThat(layout.getName().toString()).isEqualTo("modernfoundry:full");

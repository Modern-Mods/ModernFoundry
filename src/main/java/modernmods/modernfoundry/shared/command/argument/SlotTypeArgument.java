...
import modernmods.modernfoundry.shared.command.argument.SlotTypeArgument.OptionalSlotType;
...
public class SlotTypeArgument implements ArgumentType<OptionalSlotType> {
  ...
  private static final DynamicCommandExceptionType SLOT_TYPE_NOT_FOUND = new DynamicCommandExceptionType(name -> Component.translatable("command.modernfoundry.slot_type.not_found", name));

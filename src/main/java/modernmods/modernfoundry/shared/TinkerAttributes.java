...
public class TinkerAttributes {
  ...
  public TinkerAttributes() {
    ATTRIBUTES.register(modernmods.modernfoundry.TConstruct.getModBus());
  }
  ...
  /** Percentage boost to critical hits for any airborne attacker, used for {@link modernmods.modernfoundry.tools.data.ModifierIds#dragonborn} */
  ...
  /** Percentage boost to damage while crouching, used by {@link modernmods.modernfoundry.tools.data.ModifierIds#shulking} */
  ...
  /** Percentage boost to negative potion effects, used for {@link modernmods.modernfoundry.tools.data.ModifierIds#magicProtection} */

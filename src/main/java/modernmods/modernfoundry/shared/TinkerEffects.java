...
import modernmods.modernfoundry.shared.effect.AntigravityEffect;
import modernmods.modernfoundry.shared.effect.ReturningEffect;
...
import modernmods.modernfoundry.tools.modifiers.traits.skull.SelfDestructiveModifier.SelfDestructiveEffect;
...
public class TinkerEffects extends TinkerModule {
  ...
  public TinkerEffects() {
    POTIONS.register(modernmods.modernfoundry.TConstruct.getModBus());

...
import modernmods.modernfoundry.fluids.fluids.SlimeFluid;
import modernmods.modernfoundry.fluids.item.BottleItem;
import modernmods.modernfoundry.fluids.item.ContainerFoodItem;
import modernmods.modernfoundry.fluids.item.ContainerFoodItem.FluidContainerFoodItem;
import modernmods.modernfoundry.fluids.item.MagmaBottleItem;
import modernmods.modernfoundry.fluids.item.PotionBucketItem;
import modernmods.modernfoundry.fluids.util.BottleBrewingRecipe;
import modernmods.modernfoundry.fluids.util.EmptyBottleIntoEmpty;
import modernmods.modernfoundry.fluids.util.EmptyBottleIntoWater;
import modernmods.modernfoundry.fluids.util.FillBottle;

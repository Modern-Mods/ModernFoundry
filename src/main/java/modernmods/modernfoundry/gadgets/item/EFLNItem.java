...
/** @deprecated use {@link modernmods.modernfoundry.library.tools.item.ModifiableShurikenItem} with {@link modernmods.modernfoundry.library.modifiers.modules.combat.ProjectileExplosionModule} */
@Deprecated

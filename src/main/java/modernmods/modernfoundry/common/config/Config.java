...
public class Config {
  ...
  public static class Common {
    ...
    Common(ModConfigSpec.Builder builder) {
      ...
      this.addGravelToFlintRecipe = builder
        ...
        .translation("modernfoundry.configgui.addGravelToFlintRecipe")
        .worldRestart()
      ...
      this.glassRecipeFix = builder
        ...
        .translation("modernfoundry.configgui.glassRecipeFix")
        .worldRestart()
      ...
      for (TinkerHeadType headType : TinkerHeadType.values()) {
        headDrops.put(headType, builder
          .translation("modernfoundry.configgui.heads." + headType.getSerializedName())
      ...
      this.disableSideInventoryWhitelist = builder
        .comment("Set to true if you wish to test whether a side inventory works without constantly reloading datapacks.",
                "Once you find an inventory works, add it to the block entity tag `modernfoundry:side_inventories` and disable this option; leaving it enabled will lead to crashes and dupe bugs.")
  ...
  /**
   * Client specific configuration - only loaded clientside from modernfoundry-client.toml
   */
...
//        .translation("modernfoundry.configgui.temperatureInCelsius")
//        .define("temperatureInCelsius", true);
      ...
      this.tankFluidModel = builder
        ...
        .translation("modernfoundry.configgui.tankFluidModel")
      ...
      this.logMissingMaterialTextures = builder
        ...
        .translation("modernfoundry.configgui.logMissingMaterialTextures")
      ...
      builder.comment("JEI configuration").push("jei");
      {
        this.showModifiersInJEI = builder
          ...
          .translation("modernfoundry.configgui.showModifiersInJEI")
        ...
        this.showOnlyToolMaterial = builder
          ...
          .translation("modernfoundry.configgui.showOnlyToolMaterial")
          .worldRestart()
        ...
        this.showOnlyPartMaterial = builder
          ...
          .translation("modernfoundry.configgui.showOnlyPartMaterial")
          .worldRestart()
        ...
        this.showAllTableVariants = builder
          ...
          .translation("modernfoundry.configgui.showAllTableVariants")
        ...
        this.showAllAnvilVariants = builder
          ...
          .translation("modernfoundry.configgui.showAllAnvilVariants")
        ...
        this.showAllSmelteryVariants = builder
          ...
          .translation("modernfoundry.configgui.showAllSmelteryVariants")

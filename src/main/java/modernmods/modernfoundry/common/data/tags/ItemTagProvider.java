...
public class ItemTagProvider extends ItemTagsProvider {
  ...
  private void addTools() {
    ...
    addToolTags(TinkerTools.helixBlade, MULTIPART_TOOL, DURABILITY, HARVEST, MELEE_PRIMARY, INTERACTABLE_RIGHT, SWORD, SMALL_TOOLS, BONUS_SLOTS, ItemTags.SWORDS, AOE);
    // ranged
    ...
    addToolTags(TinkerTools.backpack, MULTIPART_TOOL, DURABILITY, BONUS_SLOTS, DYEABLE, TRIM, CHESTPLATES, Tags.Items.ARMORS_CHESTPLATES);
  ...
  public String getName() {
    return "Modern Foundry Item Tags";
  }

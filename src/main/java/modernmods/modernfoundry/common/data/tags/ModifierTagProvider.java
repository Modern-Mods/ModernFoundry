...
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.AOE_INTERACTION;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.ARMOR_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.ARMOR_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BLOCK_WHILE_CHARGING;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BONUS_SLOTLESS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BOOT_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BOOT_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BYPASS_EXTRA_DURABILITY;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BYPASS_FROSTSHIELD;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BYPASS_OVERSLIME;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BYPASS_REINFORCED;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.BYPASS_TANNED;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.CHARGE_EMPTY_BOW_WITHOUT_DRAWTIME;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.CHARGE_EMPTY_BOW_WITH_DRAWTIME;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.CHESTPLATE_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.CHESTPLATE_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.COSMETIC_SLOTLESS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.DAMAGE_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.DEFENSE;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.DRILL_ATTACKS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.DUAL_INTERACTION;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.EXTRACT_MODIFIER_BLACKLIST;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.EXTRACT_SLOTLESS_BLACKLIST;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.EXTRACT_UPGRADE_BLACKLIST;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.GEMS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.GENERAL_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.GENERAL_ARMOR_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.GENERAL_ARMOR_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.GENERAL_SLOTLESS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.GENERAL_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.HARVEST_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.HARVEST_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.HELMET_ABILITIES;
...
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.INVISIBLE_INK_BLACKLIST;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.KNOCKBACK_SLINGS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.LEGGING_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.LEGGING_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.MELEE_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.MELEE_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.OVERSLIME_FRIEND;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.PROTECTION_DEFENSE;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.RANGED_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.RANGED_UPGRADES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.REMOVE_MODIFIER_BLACKLIST;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.SECONDARY_DURABILITY;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.SELF_KNOCKBACK_SLINGS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.SHIELD_ABILITIES;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.SLIME_DEFENSE;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.SLOTLESS;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.SPECIAL_DEFENSE;
import static modernmods.modernfoundry.common.TinkerTags.Modifiers.TARGET_KNOCKBACK_SLINGS;
...
public class ModifierTagProvider extends AbstractModifierTagProvider {
  ...
  protected void addTags() {
    ...
    this.tag(GENERAL_ABILITIES).add(
      ...
      ModifierIds.luck, ModifierIds.lengthy, TinkerModifiers.melting.getId());

...
public class TinkerTags {
  ...
  public static class Items {
    ...
    /** @deprecated Modifier using this tag is planned for removal. See {@link modernmods.modernfoundry.tools.modules.interaction.FireballModule} for replacement. */
    @Deprecated
    ...
    /** Tools that can adjust the loot context for {@link modernmods.modernfoundry.library.modifiers.hook.behavior.ProcessLootModifierHook} */
    ...
    /** Bows supporting the ballista modifier. In code, only {@link modernmods.modernfoundry.library.tools.item.ranged.ModifiableBowItem} implements this functionality. */
    ...
    // compat tags
    /** @deprecated necronium bones now show based on {@link modernmods.modernfoundry.tools.data.material.MaterialIds#necronium} */
    @Deprecated(forRemoval = true)
  ...
  public static class Fluids {
    ...
    /** @deprecated Fluids have all been given unique effects, use {@link modernmods.modernfoundry.library.data.tinkering.AbstractFluidEffectProvider} */
    @Deprecated(forRemoval = true)
    ...
    /** Any fluids in this tag will have block {@link modernmods.modernfoundry.library.modifiers.fluid.FluidEffects} run when fired using the chem thrower */
    public static final TagKey<Fluid> CHEMTHROWER_BLOCK_EFFECTS = local("chemthrower_effects/block");
    /** Any fluids in this tag will have entity {@link modernmods.modernfoundry.library.modifiers.fluid.FluidEffects} run when fired using the chem thrower */
    public static final TagKey<Fluid> CHEMTHROWER_ENTITY_EFFECTS = local("chemthrower_effects/entity");
    /** Any fluids in this tag will have both block and entity {@link modernmods.modernfoundry.library.modifiers.fluid.FluidEffects} run when fired using the chem thrower */
  ...
  public static class Materials {
    ...
    /** Materials acting as compatability metals. Will allow them to use {@link modernmods.modernfoundry.tools.TinkerToolParts#fakeIngot} assuming they lack an ingot. */
    public static final TagKey<IMaterial> COMPATABILITY_METALS = local("compatibility_metals");
    /** Materials acting as compatability metals with a block form. Will allow them to use {@link modernmods.modernfoundry.tools.TinkerToolParts#fakeStorageBlock}. */
    public static final TagKey<IMaterial> COMPATABILITY_BLOCKS = local("compatibility_metals/blocks");
    /** Materials acting as compatability alloys. Will allow them to use {@link modernmods.modernfoundry.tables.TinkerTables#tinkersAnvil}. Typically, the same as {@link #COMPATABILITY_BLOCKS}, though left separate for datapack flexibility. */

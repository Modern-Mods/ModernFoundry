...
import modernmods.modernfoundry.library.modifiers.hook.display.RequirementsModifierHook;
...
import modernmods.modernfoundry.library.modifiers.hook.mining.HarvestEnchantmentsModifierHook;
...
public class ModifierHooks {
  ...
  /** Hook for providing a BlockItem via the {@link modernmods.modernfoundry.library.tools.capability.BlockItemProviderCapability}*/
  ...
  /** Same as {@link #VALIDATE}, but only called on modifiers in {@link modernmods.modernfoundry.library.tools.nbt.ToolStack#getUpgrades()}. */
  ...
  /** Hook called when {@link modernmods.modernfoundry.tools.modules.ranged.ammo.ProjectileFuseModule} removes a projectile. */
  ...
  /* Sling */
  /** Hook called when {@link modernmods.modernfoundry.tools.modules.interaction.sling.SlingModule} is calculating its force for the effect. */
  ...
  /** Hook called when {@link modernmods.modernfoundry.tools.modules.interaction.sling.SlingModule} is calculating the angle for the effect. */
  ...
  /** Hook called after {@link modernmods.modernfoundry.tools.modules.interaction.sling.SlingModule} moved the targeted entity. */
  ...
  /** Registers a new modifier hook under {@code modernfoundry} */
  ...
  /** Registers a new modifier hook under {@code modernfoundry}  that cannot merge */

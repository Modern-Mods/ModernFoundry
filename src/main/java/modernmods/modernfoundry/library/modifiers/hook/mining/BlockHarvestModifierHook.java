 ...
 * TODO 1.21: rename to distinguish from {@link modernmods.modernfoundry.library.modifiers.hook.special.PlantHarvestModifierHook}
 * <br>
 * Alternatives:
 * <ul>
...
public interface BlockHarvestModifierHook {
  /**
   * Called when a tool is about to break blocks to allow setting markers on the tool for hooks with less context (such as {@link modernmods.modernfoundry.library.modifiers.hook.behavior.EnchantmentModifierHook}).
   ...
   * @see modernmods.modernfoundry.library.modifiers.modules.technical.MarkHarvestingModule
   */

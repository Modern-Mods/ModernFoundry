package modernmods.modernfoundry.library.modifiers.hook.special.sling;
...
/** Modifier hook to change the force for {@link modernmods.modernfoundry.tools.modifiers.ability.sling.SlingModifier}. */
public interface SlingForceModifierHook {
   ...
   * @param slingSource Modifier entry of the sling modifier, such as {@link modernmods.modernfoundry.tools.data.ModifierIds#flinging}

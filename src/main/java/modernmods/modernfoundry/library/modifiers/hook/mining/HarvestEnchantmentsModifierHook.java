...
public interface HarvestEnchantmentsModifierHook {
  /** Slots that can use this hook, for mainhand its more efficient to instead use {@link BlockHarvestModifierHook} and {@link modernmods.modernfoundry.library.modifiers.hook.behavior.EnchantmentModifierHook} */

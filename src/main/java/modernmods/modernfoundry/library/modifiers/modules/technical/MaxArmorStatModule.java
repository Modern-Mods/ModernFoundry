...
import modernmods.hilt.data.loadable.LegacyLoadable;
...
import modernmods.modernfoundry.library.modifiers.data.ModifierMaxLevel;
...
import modernmods.modernfoundry.library.tools.capability.TinkerDataCapability.Holder;
...
/** @deprecated use {@link modernmods.modernfoundry.library.modifiers.modules.armor.MaxArmorAttributeModule} */
...
public record MaxArmorStatModule(TinkerDataKey<Float> statKey, LevelingValue amount, ComputableDataKey<ModifierMaxLevel> maxLevel, boolean allowBroken, @Nullable TagKey<Item> heldTag, ArmorStatModule.TooltipStyle tooltipStyle, ModifierCondition<IToolStackView> condition) implements ModifierModule, TooltipModifierHook, MaxArmorLevelModule {
  public static final RecordLoadable<MaxArmorStatModule> LOADER = LegacyLoadable.message(RecordLoadable.create(
    ...
    MaxArmorStatModule::new), "Found deprecated modifier module loader 'modernfoundry:max_armor_stat', use 'modernfoundry:max_armor_attribute' with attributes instead of float stats.");

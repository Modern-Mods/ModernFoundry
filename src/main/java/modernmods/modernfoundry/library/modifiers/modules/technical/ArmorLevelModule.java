...
/**
 * Module for keeping track of the total level of a modifier across all pieces of equipment. Does not support incremental, use {@link modernmods.modernfoundry.library.modifiers.modules.behavior.AttributeModule} for that.
 * @see modernmods.modernfoundry.library.modifiers.modules.behavior.AttributeModule
 * @see modernmods.modernfoundry.library.modifiers.modules.behavior.ShowOffhandModule

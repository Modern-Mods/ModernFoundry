 ...
 * @apiNote This class is internal, no need to use directly. Instead, make use of the helpers in {@link modernmods.modernfoundry.library.data.tinkering.AbstractFluidEffectProvider}.
 */
@Internal

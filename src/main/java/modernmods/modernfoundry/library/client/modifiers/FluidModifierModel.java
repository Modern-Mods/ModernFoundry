 ...
 * @deprecated use {@link modernmods.modernfoundry.library.client.modifiers.model.FluidModifierModel}
 */
@Deprecated
  ...
  */
  ...
  public void addQuads(IToolStackView tool, ModifierEntry entry, Function<Material,TextureAtlasSprite> spriteGetter, Transformation transforms, boolean isLarge, int startTintIndex, Consumer<Collection<BakedQuad>> quadConsumer, @Nullable ItemLayerPixels pixels) {
    ...
    if (!fluid.isEmpty()) {
      ...
      if (template != null) {
        modernmods.modernfoundry.library.client.modifiers.model.FluidModifierModel.addQuads(fluid, template, spriteGetter, transforms, quadConsumer);
      }
    }

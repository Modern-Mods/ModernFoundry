...
import modernmods.modernfoundry.library.tools.definition.module.display.MaterialToolName;
import modernmods.modernfoundry.library.tools.definition.module.display.ToolNameHook;
import modernmods.modernfoundry.library.tools.definition.module.interaction.InteractionToolModule;
import modernmods.modernfoundry.library.tools.definition.module.material.MaterialRepairToolHook;
import modernmods.modernfoundry.library.tools.definition.module.material.MaterialRepairToolHook.MaxMerger;
import modernmods.modernfoundry.library.tools.definition.module.material.MissingMaterialsToolHook;
...
import modernmods.modernfoundry.library.tools.definition.module.mining.MiningTierToolHook;
...
public class ToolHooks {
  ...
  /** Registers a new tool hook under {@code modernfoundry} that merges */
  ...
  /** Registers a new tool hook under {@code modernfoundry} that cannot merge */

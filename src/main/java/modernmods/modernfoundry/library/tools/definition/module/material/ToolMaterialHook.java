...
public interface ToolMaterialHook {
  ...
  /**
   * Gets the scaling factor for this material stat. Used notably in {@link modernmods.modernfoundry.library.materials.stats.IMaterialStats#getLocalizedInfo(float)}.
   * @param definition  Tool definition instance

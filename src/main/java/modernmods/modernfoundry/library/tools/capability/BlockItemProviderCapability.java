...
public interface BlockItemProviderCapability {
  ...
  static void register() {
    modernmods.modernfoundry.TConstruct.getModBus().addListener(EventPriority.NORMAL, false, RegisterCapabilitiesEvent.class, BlockItemProviderCapability::register);
  }

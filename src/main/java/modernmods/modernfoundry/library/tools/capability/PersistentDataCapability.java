...
import modernmods.modernfoundry.common.network.SyncPersistentDataPacket;
...
public class PersistentDataCapability {
  ...
  public static void register() {
    modernmods.modernfoundry.TConstruct.getModBus().addListener(EventPriority.NORMAL, false, RegisterCapabilitiesEvent.class, PersistentDataCapability::register);

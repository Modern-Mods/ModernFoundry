...
public interface ITinkerStationRecipe extends ICommonRecipe<ITinkerStationContainer> {
   ...
   * In most cases, it's better to use {@link modernmods.modernfoundry.library.recipe.modifiers.adding.AbstractModifierRecipe}{@code #success()} as it responds to your specific {@link #shrinkToolSlotBy()}.
   */

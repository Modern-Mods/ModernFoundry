...
import modernmods.modernfoundry.library.tools.definition.module.aoe.IBoxExpansion;
...
import modernmods.modernfoundry.tools.ToolDefinitions;
...
import static modernmods.modernfoundry.tools.TinkerToolParts.adzeHead;
import static modernmods.modernfoundry.tools.TinkerToolParts.arrowHead;
import static modernmods.modernfoundry.tools.TinkerToolParts.arrowShaft;
import static modernmods.modernfoundry.tools.TinkerToolParts.bowGrip;
import static modernmods.modernfoundry.tools.TinkerToolParts.bowLimb;
import static modernmods.modernfoundry.tools.TinkerToolParts.bowstring;
...
import static modernmods.modernfoundry.tools.TinkerToolParts.toughHandle;
...
public class ToolDefinitionDataProvider extends AbstractToolDefinitionDataProvider {
  ...
  protected void addToolDefinitions() {
    ...
    defineArmor(ArmorDefinitions.SLIMESUIT)
      ...
      // chestplate - slime
      .module(ArmorType.CHESTPLATE, MaterialStatsModule.stats().stat(RepairStats.RIBCAGE.getStatId()).stat(SlimeStats.ID, 1.6f).build())
      ...
      .module(ArmorType.LEGGINGS, MaterialStatsModule.stats().stat(RepairStats.SHELL.getStatId()).stat(SlimeStats.ID, 1.5f).build())
      ...
      .module(ArmorType.BOOTS, MaterialStatsModule.stats().stat(RepairStats.LACES.getStatId()).stat(SlimeStats.ID, 1.3f).build())

...
import modernmods.modernfoundry.library.data.AbstractToolItemModelProvider;
 ...
 * TODO 1.21: move to {@link modernmods.modernfoundry.tools.data.client}
 */
public class ToolItemModelProvider extends AbstractToolItemModelProvider {
  ...
  protected void addModels() throws IOException {
    ...
    tool(TinkerTools.greatsword, toolBlocking, "head");
    tool(TinkerTools.cleaver, toolBlocking, "head", "shield");
    tool(TinkerTools.pike, toolBlocking, "head");
    tool(TinkerTools.lance, toolBlocking, "head");
    // scythe

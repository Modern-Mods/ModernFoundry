...
import modernmods.modernfoundry.library.data.recipe.IToolRecipeHelper;
import modernmods.modernfoundry.library.json.predicate.material.MaterialHasPartPredicate;
import modernmods.modernfoundry.library.json.predicate.material.MaterialPredicate;
import modernmods.modernfoundry.library.json.predicate.material.MaterialStatTypePredicate;
...
import modernmods.modernfoundry.library.recipe.casting.material.CompositeCastingRecipeBuilder;
import modernmods.modernfoundry.library.recipe.casting.material.MaterialCastingRecipeBuilder;
import modernmods.modernfoundry.library.recipe.casting.material.PartSwapCastingRecipeBuilder;
...
import modernmods.modernfoundry.library.recipe.material.MaterialsConsumerBuilder;
import modernmods.modernfoundry.library.recipe.partbuilder.PartRecipeBuilder;
import modernmods.modernfoundry.library.recipe.partbuilder.Pattern;
import modernmods.modernfoundry.library.recipe.partbuilder.recycle.PartBuilderRecycleBuilder;
import modernmods.modernfoundry.library.recipe.partbuilder.recycle.PartBuilderToolRecycleBuilder;
import modernmods.modernfoundry.library.recipe.tinkerstation.building.MaterialSwappingRecipeBuilder;
import modernmods.modernfoundry.library.recipe.tinkerstation.building.ToolBuildingRecipeBuilder;
...
public class ToolsRecipeProvider extends BaseRecipeProvider implements IMaterialRecipeHelper, IToolRecipeHelper {
  ...
  private void addToolBuildingRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    // specialized
    ShapelessRecipeBuilder.shapeless(ITEM_LOOKUP, RecipeCategory.TOOLS, TinkerTools.flintAndBrick)
    ...
    ShapedRecipeBuilder.shaped(ITEM_LOOKUP, RecipeCategory.COMBAT, TinkerTools.travelersGear.get(ArmorType.HELMET))
      .pattern("l l")
      .pattern("glg")
      .pattern("c c")
  ...
  private void addRecycleRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    PartBuilderToolRecycleBuilder.tools(SizedIngredient.of(DifferenceIngredient.of(LazyTagIngredient.of(TinkerTags.Items.MULTIPART_TOOL), LazyTagIngredient.of(TinkerTags.Items.UNRECYCLABLE))))
  ...
  private void addPartRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    // ingot to block
    ShapedRecipeBuilder.shaped(ITEM_LOOKUP, RecipeCategory.MISC, TinkerToolParts.fakeStorageBlock)

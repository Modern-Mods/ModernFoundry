...
import static modernmods.modernfoundry.tools.data.sprite.TinkerPartSpriteProvider.INGOT;
import static modernmods.modernfoundry.tools.data.sprite.TinkerPartSpriteProvider.STORAGE_BLOCK;
import static modernmods.modernfoundry.tools.data.sprite.TinkerPartSpriteProvider.WOOD;

/**
 * This class handles all materials generated by Modern Foundry. You can freely use this in your addon to generate Modern Foundry material textures for a new tool
 * Do not use both this and {@link TinkerPartSpriteProvider} in a single generator for an addon, if you need to use both make two instances of {@link modernmods.modernfoundry.library.client.data.material.MaterialPartTextureGenerator}
 */

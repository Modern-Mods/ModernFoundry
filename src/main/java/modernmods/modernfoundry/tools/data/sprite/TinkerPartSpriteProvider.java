...
import modernmods.modernfoundry.library.client.data.material.AbstractPartSpriteProvider;
...
/**
 * This class handles all tool part sprites generated by Modern Foundry. You can freely use this in your addon to generate Modern Foundry part textures for a new material
 * Do not use both this and {@link TinkerMaterialSpriteProvider} in a single generator for an addon, if you need to use both make two instances of {@link modernmods.modernfoundry.library.client.data.material.MaterialPartTextureGenerator}
 */
public class TinkerPartSpriteProvider extends AbstractPartSpriteProvider {
  ...
  protected void addAllSpites() {
    ...
    // staff
    addSprite("staff/modifiers/modernfoundry_embellishment", WOOD);
    addSprite("staff/large_modifiers/modernfoundry_embellishment", WOOD);

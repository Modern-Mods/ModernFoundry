...
public class ClientInteractionHandler {
  ...
  /** Implements the client side of chestplate {@link modernmods.modernfoundry.library.modifiers.hook.interaction.GeneralInteractionModifierHook#onToolUse(IToolStackView, ModifierEntry, Player, InteractionHand, InteractionSource)} */
  ...
  /** Implements the client side of left click interaction for {@link modernmods.modernfoundry.library.modifiers.hook.interaction.GeneralInteractionModifierHook#onToolUse(IToolStackView, ModifierEntry, Player, InteractionHand, InteractionSource)} */
  @SubscribeEvent

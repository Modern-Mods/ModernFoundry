 ...
 * Note the former is possible with {@link IsEffectiveModule} using {@link modernmods.modernfoundry.library.json.predicate.TinkerPredicate#CAN_MELT_BLOCK}, but the latter requires tool context.
 */

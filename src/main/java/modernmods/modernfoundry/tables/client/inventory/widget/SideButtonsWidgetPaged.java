...
public class SideButtonsWidgetPaged<T extends Button> extends SideButtonsWidget<T> {
    ...
    public SideButtonsWidgetPaged(MultiModuleScreen<?> parent, int leftPos, int topPos, int columns, int rows,
        ...
        this.previousPageButton = new Button.Builder(
                Component.translatableWithFallback("button.modernfoundry.previous_page", "<"),
                new Button.OnPress() {
                    @Override
        ...
        this.nextPageButton = new Button.Builder(Component.translatableWithFallback("button.modernfoundry.next_page", ">"),
                new Button.OnPress() {
                    @Override
                    public void onPress(Button button) {
                        if (!isMaxPage(page)) {

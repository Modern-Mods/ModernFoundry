package modernmods.mantle.compat.neoforged.neoforge.common.util;
...
/**
 * Standalone functional replacement for the old Forge {@code LazyOptional}, used by Tinkers' capability
 * utility code. NeoForge removed this type; this is a self-contained lazy container with the same API surface
 * the ported code relies on. It is not tied to the NeoForge capability system.
 */
